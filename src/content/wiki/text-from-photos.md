...
- From a saved memo: open the [memo detail view](/wiki/memo-detail/), find the photo in the carousel, and tap the "Read text" button.
...
Text from Photos follows your app [language settings](/wiki/languages/). The language picker only shows the languages you've actually enabled — your primary plus the optional secondary — so if you only use Japanese, you won't see an English toggle every time. Supported languages are Japanese, English, and Dutch.
...
- [Photo & Video Capture](/wiki/photo-video-capture/) — how photos get attached in the first place
- [Memo Detail](/wiki/memo-detail/) — recognition is also reachable from saved memos
- [Languages](/wiki/languages/) — primary / secondary language setup
